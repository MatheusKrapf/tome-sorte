...
const phoneQuina = '/img/AppPresentationImage/4s.png'
const phonesMega = '/img/AppPresentationImage/33.png'
      ...
      <S.Content>
        <Fade left>
          <S.KnowWichNumbers>
            ...
            <S.TextContainer>
              <S.SearchGame>PESQUISE SEU JOGO FAVORITO</S.SearchGame>
              <S.Title>
                Saiba quais números foram <strong>sorteados</strong>
              </S.Title>
              <S.TextContent>
                <S.Text>
                  Não sabe qual é o valor do próximo concurso? Nós
        ...
        <Fade right>
          <S.WeProvide>
            <S.TextContainerSecond>
              <S.AlwaysBe>Sempre esteja atualizado</S.AlwaysBe>
              <S.TitleSecond>
